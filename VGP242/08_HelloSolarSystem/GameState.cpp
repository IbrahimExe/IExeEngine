...
void GameState::Initialize()
{
	...
	mAsteroid.mesh.Initialize(asteroid_1);
	...
	mAsteroid.textureId = TextureManager::Get()->LoadTexture(L"../../Assets/Models/Asteroid/Asteroid1/Asteroid1_BaseColor.jpg", false);
	...
	mAsteroid.matWorld = Math::Matrix4::Translation(5.0f, 10.0f, 0.0f);
...
void GameState::Render()
{
	...
	if (gCurrentPlanet == PlanetRenderTargets::Space)
	{
		...
		mSimpleTextureEffect.Render(mAsteroid);
